        ...
        for (const auto &iter : subs_dict_) {
            ...
            if (is_a<Mul>(*sub1)) {
                ...
                for (auto &p : subst->get_dict()) {
                    ...
                    auto diff_ = sub(it->second, p.second);
...
//        map_basic_basic req;
////        for (const auto &p : x.get_dict()) {
////            Mul::dict_add_term(str, *zero, p.first);
////            Mul::dict_add_term(req, *zero, p.first);
////        }
//        map_basic_basic subs_dict_Mul;
//        for (const auto &p : subs_dict_) {
//            if 
//        }
//        bool exists = true;
//        for (const auto &p : subs_dict_) {
//            auto it = x.get_dict().find(p.first);
//            if (it == x.get_dict().end() || it->second < p.second) {
//               exists = false;
//               break;
//            }
//            else {
//                Mul::dict_add_term(req, it->second - p.second, p.first);
//            }
//        }
//        if (!exists) {
//            result_ = x.rcp_from_this();
...
//        else {
//            for (const auto &p : x.get_dict()) {
//                auto it = subs_dict_.find(p.first);
//                if (it == subs_dict_.end())
//                    Mul::dict_add_term(req, p.second, p.first);
//            }    
//        }
//        
////        for (const auto &p : x.get_dict()) {
